...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings for a hotel.")]
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId, 
        [Description("The start date")] DateTime dt
        )
    {
    ...
    /// <summary>
    /// Get bookings without hotel rooms.
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings that miss a room.")]
    ...
    /// 
    [KernelFunction]
    [Description("Get all bookings for a hotel with multiple rooms")]
